...
message_to_camilla: Message = Message("camilla", "You inspire the students!")
print(message_to_camilla)
message_to_bear: Message = Message(1)
print(message_to_bear)
message_to_bear.content = "Good boy!"
message_to_bear.important = True 
print(message_to_bear)